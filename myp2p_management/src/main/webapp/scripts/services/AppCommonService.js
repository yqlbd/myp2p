var option = {};
option.url = {
    'api_admin': '/myp2p_action/admin/',
    'api_account': '/myp2p_action/account/',
    'api_user': '/myp2p_action/user/',
    'api_accountrecord': '/myp2p_action/accountrecord/',
    'api_product': '/myp2p_action/product/',
    'api_creditor': '/myp2p_action/creditor/',
    'api_match': '/myp2p_action/matchManagement/',
    'api_message': '/myp2p_action/',
    'api_UsersFunds': '/myp2p_action/UsersFunds/'
};
option.header = {
    'headers': {
