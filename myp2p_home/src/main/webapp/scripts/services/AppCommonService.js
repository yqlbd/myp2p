var option = {
    'url':{
        'api_user':'/myp2p_action/user/', //用户相关
        'api_investment':'/myp2p_action/investment/', 
        'api_productRate':'/myp2p_action/productRate/',
        'api_product':'/myp2p_action/product/', 
        'api_productAccount':'/myp2p_action/productaccount/',
        'api_acount':'/myp2p_action/account/',
        'api_verification':'/myp2p_action/verification/',
        'api_emailAuth':'/myp2p_action/emailAuth/',
        'api_paymentpwd':'/myp2p_action/paymentpwd/',
        'api_extracts':'/myp2p_action/extracts/',  //提现与支付功能
        'api_bankcardInfo':'/myp2p_action/bankCardInfo/',
        'api_charges':'/myp2p_action/charges/'
    },
    'header':{
        'headers':{
